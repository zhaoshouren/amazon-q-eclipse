...
export interface InvalidateSsoTokenError {
	errorCode: 
		...
		E_CANNOT_WRITE_SSO_CACHE |
		E_INVALID_TOKEN
}

export class InvalidateSsoTokenRequestType extends 
	ProtocolRequestType<InvalidateSsoTokenParams, InvalidateSsoTokenResult, void, InvalidateSsoTokenError, void> {
	constructor()
	{
